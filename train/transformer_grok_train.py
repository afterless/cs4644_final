...
def main():
    ...
    for epoch in range(1, args.num_epochs + 1):
        ...
        if epoch % args.save_every == 0:
            t.save(model.state_dict(), f"./checkpoints/transformer_grok_{epoch}_{args.seed}.pt")
    
    t.save(model.state_dict(), f"./checkpoints/transformer_grok_final_{args.seed}.pt")
